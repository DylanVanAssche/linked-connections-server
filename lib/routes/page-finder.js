...
class PageFinder {
    async getConnections(req, res) {
        ...
        try {
            ...
            // Reference routing: every page must be revalidated.\
            // Because of the reproducible data, the static connections are not updated. To simulate these updates, conditional GETs are disabled.
            // Worst case: all pages must be revalidated.
            /*if (rt_exists) {
